...
def readNifty(filePath: str, CoordinateOrder="xyz"):
    """
    # INPUT:
    # 1> filePath is the full path to the file, e.g. "/home/user/Desktop/BD/LIDC-IDRI-0001_GT1.nii.gz"
    # 2> CoordinateOrder: Order of dimensions in array:
...
#    If omitted default (identity) values are used
...
#
def saveNifty(
    volume: np.ndarray, metadata: Metadata, filename: str, CoordinateOrder="xyz"
):
    """
